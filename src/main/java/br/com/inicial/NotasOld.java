...
public class NotasOld extends Modulo {
	...
	public NotasOld() {
		...
		panel_3.setBounds(620, 211, 340, 152);
		...
		lblValorTotal.setBounds(277, 101, 60, 14);
		...
		btConfirmar.setBounds(838, 374, 118, 42);
		contentPane.add(btConfirmar);

		btNovaNota = new JButton("Nova Nota");
		btNovaNota.setBounds(838, 427, 118, 42);
		...
		scrollPane_2.setBounds(10, 519, 946, 157);
